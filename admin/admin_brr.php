...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['update_status'])) {
            ...
            if (in_array($newStatus, ['approved', 'completed'])) {
                $updateQuery = "UPDATE residency_requests SET status = :status WHERE user_id = :user_id";
            ...
            $deleteQuery = "DELETE FROM residency_requests WHERE user_id = :user_id";
    ...
    $query = "SELECT * FROM residency_requests";
